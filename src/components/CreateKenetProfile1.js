...
import imgkcp from '../assets/img/elliot.jpg';
class CreateKenetProfile1 extends Component {
                    ...
                    <div className="ui stacked">
                        <div className="ui grid">
                            <div className="sixteen wide column">
                                ...
                                <p className="limitWidth">Good news! A company profile already exists for a company with your email domain. You can claim it below.</p>
                            </div>
                        </div>
                        ...
                        <div className="kcpCardContainer">
                                ...
                                <div className="column">
                                    <div className="ui fluid card">
                                        <div className="content left aligned">
                                            <img alt="" className="right floated mini ui image" src={imgkcp} />
                                            ...
                                            <div className="extra content">
                                                <div className="ui grid">
                                                    <div className="sixteen wide column">
                                                        <div className="ui button">Claim</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div className="ui grid stackable">
                                <div className="eleven wide column left aligned">
                                    <p className="marginB20 limitWidth">If this is not the company you wish to associate with you can search for an alternative or create a new company.</p>
                                </div>
                                <div className="five wide column marginB10 middle aligned right aligned paddingB0 mobileCenterAligned"onClick= {this.onClickHandle}>
                                    <div className="ui basic button small blue">Search/create</div>
                                </div>
...
export default CreateKenetProfile1;