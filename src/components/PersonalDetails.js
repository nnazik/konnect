                ...
                <div className="ui grid stackable">
                    <div className="row">
                        <div className="eight wide column">
                            ...
                            <div className="ui button basic small compact blue">Choose profile image</div>
                        </div>
                    </div>
                    ...
                    <div className="sixteen wide column left aligned">
                        <div className="ui grid">
                            ...
                            <div className="ten wide column right aligned">
                                <span className="smallText">This becomes your username</span>
                            </div>
                        </div>
                        <div className="field">
                    ...
                    <div className="sixteen wide column right aligned saveButtons paddingT0">
